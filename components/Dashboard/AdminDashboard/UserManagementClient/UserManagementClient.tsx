...
interface User {
  id: string;
  name: string | null; // Prisma থেকে null আসতে পারে
  email: string | null;
  role: string;
  status: string;
}
...
const UserManagementClient: React.FC<Props> = ({ initialUsers }) => {
  ...
  // useMemo ব্যবহার করছি যাতে সার্চ করলে টেবিল পারফরম্যান্স ভালো থাকে
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <select
            className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 outline-none text-sm font-bold text-slate-600 focus:ring-2 focus:ring-blue-100"
            value={roleFilter}
